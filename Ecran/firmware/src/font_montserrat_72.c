...
#ifndef FONT_MONTSERRAT_72
#define FONT_MONTSERRAT_72 1
#endif

#if FONT_MONTSERRAT_72
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t font_montserrat_72 = {
#else
lv_font_t font_montserrat_72 = {
#endif
